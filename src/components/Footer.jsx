...
function Footer() {
  return (
    <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5 mt-10 pt-32'>
      <div className='w-1/2 h-full font-semibold flex flex-col justify-between'>
        <div className='heading'>
            <h1 className='text-[5vw] tracking-tighter leading-none -mb-[1vw]'>EYE-</h1>
            <h1 className='text-[5vw] tracking-tighter leading-none -mb-10'>OPENING</h1>
        </div>
      ...
      <div className='w-1/2 flex flex-col justify-between'>
        <div>
            <h1 className='text-[5vw] uppercase font-semibold tracking-tighter leading-none -mb-[2vw]'>Presentations
            
            </h1>
            <div className='dets font-[Neue_Montreal] flex flex-col'>
                <a className=' text-xl font-normal mt-10 leading-none' href="#">Facebook</a>
                <a className=' text-xl font-normal mt-10 leading-none' href="#">Instagram</a>
                <a className=' text-xl font-normal mt-10 leading-none' href="#">Twitter</a>
            </div>
        </div>
        <h1 className='text-md  text-zinc-700 font-[Neue_Montreal]'>&copy;vishnu design 2024. Legal Terms</h1>
      </div>
    </div>
  )
}
